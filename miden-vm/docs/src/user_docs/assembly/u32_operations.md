...
| u32split <br /> - *(1 cycle)*                    | [a, ...]    | [b, c, ...]   | $b \leftarrow a \mod 2^{32}$, $c \leftarrow \lfloor{a / 2^{32}}\rfloor$                                                        |
...
| Instruction                                                                               | Stack_input    | Stack_output  | Notes                                                                                                                                                                                  |
| ----------------------------------------------------------------------------------------- | -------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| u32widening_add <br /> - *(1 cycle)* <br /> u32widening_add.*b* <br /> - *(2-3 cycles)*           | [b, a, ...]    | [c, d, ...]   | $c \leftarrow (a + b) \mod 2^{32}$ <br /> $d \leftarrow \begin{cases} 1, & \text{if}\ (a + b) \ge 2^{32}  0, & \text{otherwise}\ \end{cases}$ <br /> Together, $[c, d]$ forms the 64-bit sum with $c$ as the low limb. <br /> Undefined if $max(a, b) \ge 2^{32}$ |
| u32overflowing_add <br /> - *(2 cycles)* <br /> u32overflowing_add.*b* <br /> - *(3-4 cycles)*   | [b, a, ...]    | [d, c, ...]   | $c \leftarrow (a + b) \mod 2^{32}$ <br /> $d \leftarrow \begin{cases} 1, & \text{if}\ (a + b) \ge 2^{32}  0, & \text{otherwise}\ \end{cases}$ <br /> Output order is $[d, c]$ (carry on top). Together, $[c, d]$ forms the 64-bit sum with $c$ as the low limb. <br /> Undefined if $max(a, b) \ge 2^{32}$ |
| u32wrapping_add <br /> - *(3 cycles)* <br /> u32wrapping_add.*b* <br /> - *(4-5 cycles)*        | [b, a, ...]    | [c, ...]      | $c \leftarrow (a + b) \mod 2^{32}$ <br /> Undefined if $max(a, b) \ge 2^{32}$                                                                                                            |
| u32widening_add3 <br /> - *(1 cycle)*                                                    | [c, b, a, ...] | [d, e, ...]   | $d \leftarrow (a + b + c) \mod 2^{32}$, <br /> $e \leftarrow \lfloor (a + b + c) / 2^{32}\rfloor$ <br /> Together, $[d, e]$ forms the 64-bit sum with $d$ as the low limb. <br /> Undefined if $max(a, b, c) \ge 2^{32}$ <br />                                       |
| u32overflowing_add3 <br /> - *(2 cycles)*                                                    | [c, b, a, ...] | [e, d, ...]   | $d \leftarrow (a + b + c) \mod 2^{32}$, <br /> $e \leftarrow \lfloor (a + b + c) / 2^{32}\rfloor$ <br /> Output order is $[e, d]$ (carry on top). Together, $[d, e]$ forms the 64-bit sum with $d$ as the low limb. <br /> Undefined if $max(a, b, c) \ge 2^{32}$ <br />                                       |
| u32wrapping_add3 <br /> - *(3 cycles)*                                                      | [c, b, a, ...] | [d, ...]      | $d \leftarrow (a + b + c) \mod 2^{32}$, <br /> Undefined if $max(a, b, c) \ge 2^{32}$ <br />                                                                                               |
...
| u32widening_mul <br /> - *(1 cycle)* <br /> u32widening_mul.*b* <br /> - *(2-3 cycles)*         | [b, a, ...]    | [c, d, ...]   | $c \leftarrow (a \cdot b) \mod 2^{32}$ <br /> $d \leftarrow \lfloor(a \cdot b) / 2^{32}\rfloor$ <br /> Undefined if $max(a, b) \ge 2^{32}$                                                 |

...
fn compute_account_seed_single(
    ...
    let mut current_seed: Word = [
        Felt::new(u64::from_le_bytes(init_seed[0])).expect("invalid field element"),
        Felt::new(u64::from_le_bytes(init_seed[1])).expect("invalid field element"),
        Felt::new(u64::from_le_bytes(init_seed[2])).expect("invalid field element"),
        Felt::new(u64::from_le_bytes(init_seed[3])).expect("invalid field element"),
    ].into();

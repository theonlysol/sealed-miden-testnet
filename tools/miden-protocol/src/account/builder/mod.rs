...
mod tests {
    ...
    impl From<CustomComponent1> for AccountComponent {
        fn from(custom: CustomComponent1) -> Self {
            ...
            value[0] = Felt::new(custom.slot0).expect("invalid field element");
    ...
    impl From<CustomComponent2> for AccountComponent {
        fn from(custom: CustomComponent2) -> Self {
            ...
            value0[3] = Felt::new(custom.slot0).expect("invalid field element");
            let mut value1 = Word::empty();
            value1[3] = Felt::new(custom.slot1).expect("invalid field element");
    ...
    fn account_builder() {
        ...
        assert_eq!(
            ...
            [Felt::new(storage_slot0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element")].into()
        );
        assert_eq!(
            account.storage().get_item(&CUSTOM_COMPONENT2_SLOT_NAME0).unwrap(),
            [Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(storage_slot1).expect("invalid field element")].into()
        );
        assert_eq!(
            account.storage().get_item(&CUSTOM_COMPONENT2_SLOT_NAME1).unwrap(),
            [Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(storage_slot2).expect("invalid field element")].into()
        );
    }

...
fn map_slot_schema_default_values_returns_map() {
    ...
    default_values.insert(
        Word::from([Felt::new(1).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element")]),
        Word::from([Felt::new(10).expect("invalid field element"), Felt::new(11).expect("invalid field element"), Felt::new(12).expect("invalid field element"), Felt::new(13).expect("invalid field element")]),
    );
...
fn value_slot_schema_accepts_typed_word_init_value() {
    ...
    let expected = Word::from([Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element"), Felt::new(4).expect("invalid field element")]);
...
fn value_slot_schema_accepts_felt_typed_word_init_value() {
    ...
    let built = slot.try_build_word(&init_data, &slot_name).unwrap();
    assert_eq!(built, Word::from([Felt::new(6).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element"), Felt::new(0).expect("invalid field element")]));
}
...
fn value_slot_schema_accepts_typed_felt_init_value_in_composed_word() {
    let word = WordSchema::new_value([
        FeltSchema::u8("a"),
        FeltSchema::felt("b").with_default(Felt::new(2).expect("invalid field element")),
        FeltSchema::felt("c").with_default(Felt::new(3).expect("invalid field element")),
        FeltSchema::felt("d").with_default(Felt::new(4).expect("invalid field element")),
    ]);
    ...
    let built = slot.try_build_word(&init_data, &slot_name).unwrap();
    assert_eq!(built, Word::from([Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element"), Felt::new(4).expect("invalid field element")]));
}

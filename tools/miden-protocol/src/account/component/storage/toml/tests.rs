...
fn extensive_schema_metadata_and_init_toml_example() {
    ...
    let expected_token_metadata =
        Word::from([Felt::new(1_000_000u32).expect("invalid field element"), symbol_felt, Felt::new(6u8).expect("invalid field element"), Felt::ZERO]);
    ...
    assert_eq!(
        ...
        &Word::from([Felt::new(7u8).expect("invalid field element"), Felt::ZERO, Felt::ZERO, Felt::ZERO])
    );
    ...
    assert_eq!(
        static_word,
        &Word::from([Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element"), Felt::new(4).expect("invalid field element")])
    );
    ...
    assert_eq!(
        ...
        Word::from([Felt::ZERO, Felt::ZERO, Felt::ZERO, Felt::new(32).expect("invalid field element")])
    );
    ...
    assert_eq!(
        ...
        Word::from([Felt::new(16).expect("invalid field element"), Felt::ZERO, Felt::ZERO, Felt::ZERO])
    );

...
impl Blockchain {
    ...
    pub fn peaks_at(&self, checkpoint: BlockNumber) -> Result<MmrPeaks, MmrError> {
        self.mmr.peaks_at(Forest::new(checkpoint.as_usize()).expect("invalid forest"))
    }
    ...
    pub fn open_at(
        ...
        self.mmr.open_at(block.as_usize(), Forest::new(checkpoint.as_usize()).expect("invalid forest"))
    }

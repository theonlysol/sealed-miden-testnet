...
impl BlockHeader {
    ...
    fn compute_sub_commitment(
        ...
        elements.extend([block_num.into(), Felt::new(version as u64).expect("invalid field element"), Felt::new(timestamp as u64).expect("invalid field element"), ZERO]);
        elements.extend([
            ZERO,
            Felt::new(fee_parameters.verification_base_fee() as u64).expect("invalid field element"),

...
mod tests {
    ...
    #[case::attachment_array(NoteAttachment::new_array(
        ...
        vec![Felt::new(5).expect("invalid field element"), Felt::new(6).expect("invalid field element"), Felt::new(7).expect("invalid field element")],
    )?)]
    #[test]
    ...
    fn note_attachment_commitment_fails_on_too_many_elements() -> anyhow::Result<()> {
        ...
        let elements = vec![Felt::new(1u32).expect("invalid field element"); too_many_elements];

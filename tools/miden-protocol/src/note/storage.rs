...
mod tests {
    ...
    fn test_storage_item_ordering() {
        ...
        let storage_items = vec![Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element")];
        // we expect the storage items to remain in reverse stack order.
        let expected_ordering = vec![Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element")];

...
pub const STORAGE_VALUE_0: Word =
    Word::new([Felt::new(1).expect("invalid field element"), Felt::new(2).expect("invalid field element"), Felt::new(3).expect("invalid field element"), Felt::new(4).expect("invalid field element")]);
pub const STORAGE_VALUE_1: Word =
    Word::new([Felt::new(5).expect("invalid field element"), Felt::new(6).expect("invalid field element"), Felt::new(7).expect("invalid field element"), Felt::new(8).expect("invalid field element")]);
pub const STORAGE_LEAVES_2: [(Word, Word); 2] = [
    (
        Word::new([Felt::new(101).expect("invalid field element"), Felt::new(102).expect("invalid field element"), Felt::new(103).expect("invalid field element"), Felt::new(104).expect("invalid field element")]),
        Word::new([Felt::new(1_u64).expect("invalid field element"), Felt::new(2_u64).expect("invalid field element"), Felt::new(3_u64).expect("invalid field element"), Felt::new(4_u64).expect("invalid field element")]),
    ),
    (
        Word::new([Felt::new(105).expect("invalid field element"), Felt::new(106).expect("invalid field element"), Felt::new(107).expect("invalid field element"), Felt::new(108).expect("invalid field element")]),
        Word::new([Felt::new(5_u64).expect("invalid field element"), Felt::new(6_u64).expect("invalid field element"), Felt::new(7_u64).expect("invalid field element"), Felt::new(8_u64).expect("invalid field element")]),
    ),
];

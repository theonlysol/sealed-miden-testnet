...
fn test_read_foreign_account_inputs_missing_data() {
    ...
    let partial_account = PartialAccount::new(
        native_account_id,
        Felt::new(10).expect("invalid field element"),
        code,
        partial_storage,
        partial_vault,
        None,
...
fn test_read_foreign_account_inputs_with_storage_data() {
    ...
    let foreign_header = AccountHeader::new(
        foreign_account_id,
        Felt::new(5).expect("invalid field element"),
        Word::default(),
    ...
    let slot1 = StorageSlotHeader::new(
        ...
        Word::new([Felt::new(10).expect("invalid field element"), Felt::new(20).expect("invalid field element"), Felt::new(30).expect("invalid field element"), Felt::new(40).expect("invalid field element")]),
    );
    let slot2 = StorageSlotHeader::new(
        slot_name2,
        StorageSlotType::Map,
        Word::new([Felt::new(50).expect("invalid field element"), Felt::new(60).expect("invalid field element"), Felt::new(70).expect("invalid field element"), Felt::new(80).expect("invalid field element")]),
    );
    ...
    assert_eq!(account_inputs.account().nonce(), Felt::new(5).expect("invalid field element"));
